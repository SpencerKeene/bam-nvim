        ...
        <>
                    ...
                    <Card sx={{maxWidth: 400, margin: 'auto'}}>
                        <CardContent>
                            ...
                            <Typography variant="body2">
                                ...
                                <br />You will be shown a 3x3 grid of patterns.
                                <br />
                                The last one, in the bottom right-hand corner, will be missing. Select the answer which fits best.
                                <br />
                                A 30 second timer will keep you on track.
                            </Typography>
                            <Typography sx={{ fontSize: 14 }} color="text.secondary" gutterBottom>
                                <br />Click anywhere outside of this box to continue.
                                <br />
            ...
            <div className='quiz'>
                ...
                <div className='quiz-header'>
                    ...
                    <img src={pqArray[count].question}
